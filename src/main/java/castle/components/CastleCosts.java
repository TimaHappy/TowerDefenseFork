...
public class CastleCosts {
    ...
    public static void load() {
        units = OrderedMap.of(
                ...
                UnitTypes.locus, new Moneys(900, 5, 250),
                UnitTypes.precept, new Moneys(2000, 12, 600),
                UnitTypes.vanquish, new Moneys(5000, 30, 1000),
                ...
                UnitTypes.tecta, new Moneys(5700, 30, 1100),
